(define (problem ex1_strip_plus_p8)
    (:domain ex1_strip_plus)
    ; OBJECT DEFINITION
    (:objects
       depot - location ;; our initial depot
       location1 location2 location3 - location ;; other location avaiable
       robot1 - robot ;; our agent
       box1 box2 box3 box4 box5 - box ;; three box avaiable
    ...
    (:init
        ...
        (be_at_person location3 person4)
        ...
        (not_assigned_box_content box5 content7)
        (not_assigned_box_content box5 content8)
        (not_assigned_box_content box5 content9)
