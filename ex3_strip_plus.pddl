...
; BRIEF DESCRIPTION:
; Domain for ex3 of APTP exam project
; PLANNING VERSION: Temporal planning, PDDL 2.1
; REQUIRE: strips + typing + equality + fluents + durative-actions
...
(define 
    ...
    (:requirements :strips :typing :equality 
    	:fluents  ;; numeric fluents adding
    ...
    (:durative-action pick_up
        ...
        :condition (and
            ...
            (at start (> (carrier_capacity ?cr ) 0))  ;; check if capacity is greater than 0
            ; force nonconcurrency
            (at start (not_agent_occupied ?r))
        ...
        :effect (and
            ...
            ; decrease capacity
            (at start (decrease (carrier_capacity ?cr ) 1)) 
            ; force nonconcurrency
            (at start  (agent_occupied ?r))
            (at end (not (agent_occupied ?r)))
            (at start  (not (not_agent_occupied ?r)))
            (at end (not_agent_occupied ?r))
            (at start (not (not_is_assigned_box ?b)))
    ...
    (:durative-action drop
        ...
        :condition (and
            ...
            ; parte carrier
            (at start (< (carrier_capacity ?cr) 4)) ;; should have at least a box carried
            ; force nonconcurrency
            (at start (not_agent_occupied ?r))
        )
        :effect (and
            ...
            (at start (not_assigned_carrier_box  ?b ?cr))
            ; parte carrier
            (at start (increase (carrier_capacity ?cr ) 1))
	    ; force nonconcurrency
            (at start  (agent_occupied ?r))
            (at end (not (agent_occupied ?r)))
            (at start  (not (not_agent_occupied ?r)))
    ...
    (:durative-action empty_medicine
        ...
        :effect (and
            ...
            (at end (not_agent_occupied ?r))
            (at end (empty_box ?b))
            (at end (not (not_satisfied_medicine ?p)))
    ...
    (:durative-action empty_tool
        ...
        :effect (and
            ...
            (at end (not_agent_occupied ?r))
            (at end (empty_box ?b))
            (at end (not (not_satisfied_tool ?p)))
    ...
    (:durative-action move_cc_4
        ...
        :condition (and
            ...
            ;; robot must be empty
            (over all (= (carrier_capacity ?cr) 4))
            ; force nonconcurrency
            (at start (not_agent_occupied ?r))
        )
        :effect (and
    ...
    (:durative-action move_cc_3_wc
        ...
        :condition (and
            ...
            (over all (= (carrier_capacity ?cr) 3))
            ; force nonconcurrency
            (at start (not_agent_occupied ?r))
        )
        :effect (and
    ...
    (:durative-action move_cc_2_wcwc
        ...
        :condition (and
            ...
            (over all (= (carrier_capacity ?cr) 2))
            ; force nonconcurrency
            (at start (not_agent_occupied ?r))
        )
        :effect (and
    ...
    (:durative-action move_cc_1_wcwcwc
        ...
        :condition (and
            ...
            (over all (= (carrier_capacity ?cr) 1))
            ; force nonconcurrency
            (at start (not_agent_occupied ?r))
        )
        :effect (and
    ...
    (:durative-action move_cc_0_wcwcwcwc
        ...
        :condition (and
            ...
            (over all (= (carrier_capacity ?cr) 0))
            ; force nonconcurrency
            (at start (not_agent_occupied ?r))
        )
        :effect (and
