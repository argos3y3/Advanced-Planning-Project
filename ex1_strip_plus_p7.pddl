(define (problem ex1_strip_plus_p7)
    ...
    (:init
        ...
        (not_assigned_box_content box6 content7)
        (not_assigned_box_content box6 content8)
        (not_assigned_box_content box6 content9)
