(define (problem ex1_strip_plus_neg_p10)
    (:domain ex1_strip_plus_neg)
    ; OBJECT DEFININTIONS
    (:objects
       depot - location ;; our initial depot
       location1 location2 location3 location4 location5 location6 - location ;; other location avaiable
       robot1 - robot ;; our agent
       box1 box2 box3 - box ;; three box avaiable
       person1 person2 person3 person4 person5 person6 - person ;; person to be rescued
    ...
    (:init
        ...
        (be_at_person location5 person5)
        (be_at_person location6 person6)
    ...
    (:goal
		...
		; deliver tool
		(or
		    (assigned_person_content content2 person6)
		    (assigned_person_content content5 person6)
		    (assigned_person_content content8 person6)
		    (assigned_person_content content11 person6)
		)
		(or
		...
		; deliver medicine
		(or
		    (assigned_person_content content3 person5)
		    (assigned_person_content content6 person5)
		    (assigned_person_content content9 person5)
		    (assigned_person_content content12 person5)
		)
		(or
