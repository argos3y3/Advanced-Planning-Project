...
(define 
    ...
    (:predicates
        ...
        (not_empty_robot ?r - robot)  ;; negated version of previos predicate 
        (assigned_robot_box ?b - box ?r - robot )  ;; true if robot is carrying an object
        (not_assigned_robot_box ?b - box ?r - robot )  ;; negated version of previos predicate
        ; content
    ...
    ; empty a box assigning content to person
    (:action empty
    ...
    ; move with box carried having content inside
    (:action move_full_wc
    ...
    ; move with box carried having not content inside
    (:action move_full_noc
        ...
        :precondition (and
            ...
            (be_at_robot ?l1 ?r)
            (be_at_box ?b ?l1)
            (empty_box ?b) ;; in this case box is empty
            (assigned_robot_box ?b ?r )
        )
        :effect (and
            ; update robot position 
