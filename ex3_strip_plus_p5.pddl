(define (problem ex3_strip_plus_p5)
    ...
    (:init
        ...
        (not_agent_occupied robot1)        
        ; initial user satisfaction
        (not_satisfied_food person1)
        (not_satisfied_tool person1)
        (not_satisfied_medicine person1)
        (not_satisfied_food person2)
        (not_satisfied_tool person2)
        (not_satisfied_medicine person2)
        (not_satisfied_food person3)
        (not_satisfied_tool person3)
        (not_satisfied_medicine person3)        
    )
    ; GOAL DEFINITION
    (:goal
        (and

		(satisfied_food  person1)
		(satisfied_tool  person2)
		(satisfied_medicine  person3)
        )
    )
)
